  ...
  <div class="box">
    ...
    ?>
      <div class="box-header with-border">
        ...
        <div  style="display: flex;  justify-content: space-between;justify-content: left;flex-wrap: wrap;margin-top:20px">
          <div> <input class="input-group" type="file" class="form-control" name="file" style="outline: none;"> </div>
